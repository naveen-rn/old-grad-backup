/* Page Fault Calculation Using FIFO Algorithm */
...
int LIFO()
{
 cout << endl << "Oops!!! " << endl << "Please read the README file and execute the proper Page Fault Algorithm" << endl;
 cout << "You have compiled only FIFO !!!" << endl;
 return 0;
}
...
int FIFO()
{
	...
	fileOP << "*******************************************************" << endl;
	fileOP << "Page Fault Calculation - FIFO Algorithm Used" << endl;
	fileOP << "*******************************************************" << endl;
 	while(!fileIP.eof())
	{
