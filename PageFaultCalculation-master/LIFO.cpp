/* Page Fault Calculation Using LIFO Algorithm */
...
int FIFO()
{
 ...
 cout << "You have compiled only LIFO !!!" << endl;
 return 0;
}
...
int LIFO()
{
	...
	fileOP << "*******************************************************" << endl;
	fileOP << "Page Fault Calculation - LIFO Algorithm Used" << endl;
	fileOP << "*******************************************************" << endl;
 	while(!fileIP.eof())
	{
					    ...
					    if ( DT1->logAddress[2] > 0 )
							{
							  ...
							  else
							  {
								  ...
								  if(!bFound)
								  {
                                      ...
                                      pQueue[iBuff].page.pop_front();                  
									  pQueue[iBuff].page.push_back(DT1->logAddress[2]);
